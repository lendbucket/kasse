-- P1.A.4: Add SERVICES_PENDING to OnboardingSession state CHECK constraint.
-- Transient sentinel state for concurrent-call serialization during services seed.
