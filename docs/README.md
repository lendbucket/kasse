...
| [REYNA_PAY_API_SPEC.md](./REYNA_PAY_API_SPEC.md) | (LIVING — Tier 2 of 3) Payment rails contract. Tier 1 (Foundation) + Tier 2 (Resources) shipped. Tier 3+4 (Non-functional + Agent-native) to follow. | LIVING |
