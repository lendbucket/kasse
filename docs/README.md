...
| [KASSE_SIDEBAR_GAP.md](./KASSE_SIDEBAR_GAP.md) | (LIVING) Audit of current Sidebar.tsx vs locked KASSE_PORTAL_ARCHITECTURE.md spec. Gap-closure roadmap for Phase 0.8-c onward. Refreshed as gaps close. | LIVING |
...
| [REYNA_PAY_API_SPEC.md](./REYNA_PAY_API_SPEC.md) | (LIVING — Complete) Payment rails contract for Kasse, SalonBacked, RunMySalon, and developer consumers. All 4 tiers shipped (Foundation, Resources, Non-functional, Agent-native). | LIVING |
