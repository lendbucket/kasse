  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        console.log("[AUTH-DIAG] authorize called", { hasEmail: !!credentials?.email, hasPassword: !!credentials?.password });
        ...
        console.log("[AUTH-DIAG] user lookup result", { found: !!user, hasPassword: !!user?.password, emailVerified: !!user?.emailVerified, isActive: !!user?.isActive });
