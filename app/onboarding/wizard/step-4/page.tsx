...
export default async function WizardStep4Page() {
  ...
  // Load staff for this org+location to decide which variant to render.
  // Identity-scoped via the session's organizationId + locationId — same
  // pattern as steps 2/3 for verticalId.
